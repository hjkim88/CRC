...
#
#   * THIS CODE USES PREDICTED RACE INFORMATION. The "RNASEQAnalysis.R" USES
#     SELF-REPORTED RACE INFORMATION.
#
#   Instruction
#               1. Source("RNASEQAnalysis2.R")
#               2. Run the function "rnaseq_parvathi2" - specify raw count path, clinical info file paths and the output directory
#               3. The results will be generated under the output directory
#
#   Example
#               > source("The_directory_of_RNASEQAnalysis2.R/RNASEQAnalysis2.R")
#               > rnaseq_parvathi2(rCntPath = "C:/Research/CUMC/GTExProj/data/RDA_Files/TCGA_RAW_COUNTS.rda",
...
rnaseq_parvathi2 <- function(rCntPath = "//isilon.c2b2.columbia.edu/ifs/archive/shares/af_lab/GTEx/RDA_Files/TCGA_RAW_COUNTS.rda",
