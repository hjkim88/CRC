...
#
#   Instruction
#               1. Source("RNASEQAnalysis4.R")
#               2. Run the function "rnaseq_parvathi4" - specify raw count path, clinical info file paths and the output directory
#               3. The results will be generated under the output directory
#
#   Example
#               > source("The_directory_of_RNASEQAnalysis4.R/RNASEQAnalysis4.R")
#               > rnaseq_parvathi4(rCntPath = "./data/rnaseq/raw_count_tcga_coad_read.rda",
...
#                                  padj_thres = 0.05,
#                                  outputDir="./results/rnaseq/preprocessed_raw_counts2/")
###

rnaseq_parvathi4 <- function(rCntPath = "//isilon.c2b2.columbia.edu/ifs/archive/shares/af_lab/GTEx/RDA_Files/TCGA_RAW_COUNTS.rda",
